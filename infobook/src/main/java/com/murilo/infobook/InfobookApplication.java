...
import com.murilo.infobook.entities.Autor;
import com.murilo.infobook.entities.Cidade;
import com.murilo.infobook.entities.Colecao;
import com.murilo.infobook.entities.Editora;
import com.murilo.infobook.entities.Endereco;
import com.murilo.infobook.entities.Estado;
import com.murilo.infobook.entities.Genero;
import com.murilo.infobook.entities.Livro;
import com.murilo.infobook.entities.Usuario;
import com.murilo.infobook.repositories.AutorRepository;
import com.murilo.infobook.repositories.CidadeRepository;
import com.murilo.infobook.repositories.ColecaoRepository;
import com.murilo.infobook.repositories.EditoraRepository;
import com.murilo.infobook.repositories.EnderecoRepository;
import com.murilo.infobook.repositories.EstadoRepository;
import com.murilo.infobook.repositories.GeneroRepository;
import com.murilo.infobook.repositories.LivroRepository;
...
public class InfobookApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cid1);
		...
		Editora ed1 = new Editora(null, "Sextante");
		Editora ed2 = new Editora(null, "Bookman");

		Genero g1 = new Genero(null, "Informática");
		Genero g2 = new Genero(null, "Fantasia");

		Autor aut1 = new Autor(null, "J.R.R. Tolkien");
		Autor aut2 = new Autor(null, "Cay Horstmann");
		...
		Livro l1 = new Livro(null, "Core Java", 320, 2.00, ed2, g1, aut2);
		Livro l2 = new Livro(null, "Senhor dos Anéis", 1100, 3.00, ed1, g2, aut1);
		Livro l3 = new Livro(null, "O Hobbit", 310, 2.00, ed1, g2, aut1);
